...
export function StatHighlight({ stat, index }: StatHighlightProps) {
  return (
    <motion.div
      ...
      className="rounded-3xl border border-amber-200/60 bg-white/80 px-6 py-5 shadow-lg shadow-amber-500/10 backdrop-blur dark:border-slate-700/80 dark:bg-slate-900/70"
    >
